          ...
          <span className="text-xs uppercase tracking-wide text-gray-500">
            Call us
              ...
              <ul className="mt-4 space-y-1 text-sm text-gray-700 max-w-[200px]">
                <li>Dahanu charoti road, Saravali, next to r.s.t weight bridge, Dahanu, Maharashtra 401602</li>
              </ul>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <ul className="mt-6 space-y-4 text-sm">
                  ...
                  <li>
                    <Link to="/cottages/aparajita" className="text-gray-700 transition hover:opacity-75">
                      Aparajita
                    </Link>
                  </li>
                </ul>

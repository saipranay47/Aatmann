  ...
  return (
    <div>
          ...
          <div className="container px-6 mx-auto text-center">
            ...
            >
              ...
              <div className="flex justify-center items-center mt-10">
                ...
                >
                  <span  className="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-black transition-colors duration-300 ease-out border-2 border-or rounded-3xl group-hover:text-tex">
                    <span  className="absolute inset-0 w-full h-full px-5 py-3 rounded-3xl bg-tex"></span>
                    <span  className="absolute left-0 w-48 h-48 -ml-2 transition-all duration-300 origin-top-right -rotate-90 -translate-x-full translate-y-12 bg-or group-hover:-rotate-180 ease"></span>
                    <span  className="relative text-xl">Book now</span>
                  </span>
                  <span
                     className="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-or rounded-3xl group-hover:mb-0 group-hover:mr-0"
      ...
      <section className="h-72 flex justify-center items-center">
        ...
        <p className=" text-tex  text-lg max-w-lg text-center p-4 md:p-0">
